		...
		<ul class="navbar-nav">
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					...
					<?php else : ?>
						<a class="dropdown-item" href="<?= base_url('about') ?>"><i class="fas fa-bullhorn"></i>&nbsp;&nbsp;Tentang</a>
						<a class="dropdown-item" href="<?= base_url('registry') ?>"><i class="fas fa-user-edit"></i>&nbsp;&nbsp;Pendaftaran</a>
						<a class="dropdown-item" href="<?= base_url('saung') ?>"><i class="fas fa-th-list"></i>&nbsp;&nbsp;Siswa</a>
